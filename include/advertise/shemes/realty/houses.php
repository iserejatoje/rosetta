...
class AdvSheme_realty_houses extends AdvSheme_realty
{
	public function __construct($path, $prefix = '')
	{
		...
		$this->sheme['scalar_fields']['HouseType']			= array( 'type' => 'int' );
...
class AdvIterator_realty_houses extends AdvIterator_realty
{
}

class Adv_realty_houses extends Adv_realty
{
