...
class AdvSheme_realty_land extends AdvSheme_realty
{
	public function __construct($path, $prefix = '')
	{
		...
		$this->sheme['scalar_fields']['Ownership']		= array( 'type' => 'int' );
...
class AdvIterator_realty_land extends AdvIterator_realty
{
}

class Adv_realty_land extends Adv_realty
{
