...
class AdvSheme_realty_gardens extends AdvSheme_realty
{
	public function __construct($path, $prefix = '')
	{
		...
		$this->sheme['scalar_fields']['GardenType']		= array( 'type' => 'int' );
...
class AdvIterator_realty_gardens extends AdvIterator_realty
{
}

class Adv_realty_gardens extends Adv_realty
{
