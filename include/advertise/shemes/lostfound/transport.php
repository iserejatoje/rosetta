...
class AdvSheme_lostfound_transport extends AdvSheme_lostfound
{
...
class AdvIterator_lostfound_transport extends AdvIterator_lostfound
{
}

class Adv_lostfound_transport extends Adv_lostfound
{
  ...
  public function IsValid()
  {
    ...
    $is_valid = true;
      ...
      $OBJECTS['uerror']->AddError(ERR_L_LOSTFOUND_BRAND);
		...
		if (!isset($this->data['Model']) || empty($this->data['Model']) || strlen($this->data['Model']) < 2){
      $OBJECTS['uerror']->AddError(ERR_L_LOSTFOUND_MODEL);
			$is_valid = false;
		}
