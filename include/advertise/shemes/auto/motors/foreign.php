...
class AdvSheme_auto_motors_foreign extends AdvSheme_auto_motors
{
	public $RubricID = 9;
...
class AdvIterator_auto_motors_foreign extends AdvIterator_auto_motors
{
...
class Adv_auto_motors_foreign extends Adv_auto_motors
{
