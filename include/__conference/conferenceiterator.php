<?
require_once ($CONFIG['engine_path'].'include/conference/conferencemgr.php');

class PConferenceIterator implements Countable, Iterator
{
	private $_list = null;
	...
	public function current ()
	{
		...
		if($this->_list !== null)
		{
			return Conference::CreateInstance(current($this->_list));
		}
		return null;	
	}
