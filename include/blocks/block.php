...
class Block
{
    ...
    private $_images_dir = '/common_fs/i/common_blocks/';
    private $_images_url = '/resources/fs/i/common_blocks/';
    ...
    */
    ...
    public function Update()
    {
        ...
        {
            return  $this->_values["blockid"] = BlockMgr::getInstance()->AddBlock($this->_values);
        }
        else
        {
            return BlockMgr::getInstance()->UpdateBlock($this->_values);
        }
    }
...
//  Удаление продуктов
    public function Remove()
    {
        ...
        return BlockMgr::getInstance()->RemoveBlock($this->_values['blockid']);
    }
