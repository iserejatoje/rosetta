...
class lib_sphinx_api
{

	const SP_CONNECT_TIMEOUT = 15;
	...
	var $_error_code = 0;	///< last error code
	...
	function _Send ( $handle, $data, $length )
	{
		if ( feof($handle) || fwrite ( $handle, $data, $length ) !== $length )
		{
			...
			$this->_error_code = self::SP_CONNECT_TIMEOUT;
			return false;
		}
		return true;
	}
