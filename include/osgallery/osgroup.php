...
class OSGroup
{
    ...
    private $_images_dir = '/common_fs/i/common_osgroup/';
    private $_images_url = '/resources/fs/i/common_osgroup/';
    ...
    public function __get($name)
    {
        ...
        if ($name == 'photos') {
            ...
            $photos = OSGalleryMgr::GetInstance()->GetPhotos($filter);
            return $photos;
        }
    ...
    */
    ...
    public function Update()
    {
        ...
        {
            return  $this->_values["groupid"] = OSGalleryMgr::getInstance()->AddGroup($this->_values);
        }
        else
        {
            return OSGalleryMgr::getInstance()->UpdateGroup($this->_values);
        }
    }
...
//  Удаление
    public function Remove()
    {
        ...
        return OSGalleryMgr::getInstance()->RemoveGroup($this->_values['groupid']);
    }
    ...
    */
    ...
    public function AddFilterParam($FilterID, $ParamID)
    {
        ...
        $sql  = "INSERT IGNORE INTO ".OSGalleryMgr::getInstance()->_tables['group_filters'] ." SET ";
    ...
    {
        $sql  = "SELECT GroupID, FilterID, ParamID FROM ".OSGalleryMgr::getInstance()->_tables['group_filters'];
    ...
    {
        $sql  = "SELECT ".OSGalleryMgr::getInstance()->_tables['filter_params'].".* FROM ".OSGalleryMgr::getInstance()->_tables['filter_params'];
        $sql .= " INNER JOIN ".OSGalleryMgr::getInstance()->_tables['filters']." ON ".OSGalleryMgr::getInstance()->_tables['filter_params'].".FilterID = ".OSGalleryMgr::getInstance()->_tables['filter_params'].".FilterID AND ".OSGalleryMgr::getInstance()->_tables['filters'].".NameID = '".addslashes($nameid)."'";
        $sql .= " INNER JOIN ".OSGalleryMgr::getInstance()->_tables['group_filters']." ON ".OSGalleryMgr::getInstance()->_tables['group_filters'].".ParamID = ".OSGalleryMgr::getInstance()->_tables['filter_params'].".ParamID AND ".OSGalleryMgr::getInstance()->_tables['group_filters'].".GroupID = ".$this->_values['groupid'];
    ...
    {
        $sql = "DELETE FROM ".OSGalleryMgr::getInstance()->_tables['group_filters']." WHERE GroupID=".$this->_values['groupid'];
        OSGalleryMgr::getInstance()->_db->query($sql);
    }
