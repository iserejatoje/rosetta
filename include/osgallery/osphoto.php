...
class OSPhoto
{
	...
	private $_images_dir = '/common_fs/i/common_osphoto/';
	private $_images_url = '/resources/fs/i/common_osphoto/';
	...
	*/
	...
	public function Update()
	{
		...
		{
			return  $this->_values["photoid"] = OSGalleryMgr::getInstance()->AddPhoto($this->_values);
		}
		else
		{
			return OSGalleryMgr::getInstance()->UpdatePhoto($this->_values);
		}
	}
...
//  Удаление продуктов
	public function Remove()
	{
		...
		return OSGalleryMgr::getInstance()->RemovePhoto($this->_values['photoid']);
	}
