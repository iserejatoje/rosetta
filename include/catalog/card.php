...
class Card
{
    ...
    */
    ...
    public function Update()
    {
        ...
        {
            return $this->_values['cardid'] = CatalogMgr::getInstance()->AddCard($this->_values);
        }
        else
        {
            return  CatalogMgr::getInstance()->UpdateCard($this->_values);
        }
    }
    ...
    public function Remove()
    {
        ...
        return CatalogMgr::getInstance()->RemoveCard($this->_values['cardid']);
    }
