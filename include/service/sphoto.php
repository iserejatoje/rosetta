...
class SPhoto
{
	...
	private $_images_dir = '/common_fs/i/common_service_photo/';
	private $_images_url = '/resources/fs/i/common_service_photo/';
	...
	*/
	...
	public function Update()
	{
		...
		{
			return  $this->_values["photoid"] = ServiceMgr::getInstance()->AddPhoto($this->_values);
		}
		else
		{
			return ServiceMgr::getInstance()->UpdatePhoto($this->_values);
		}
	}
...
//  Удаление продуктов
	public function Remove()
	{
		...
		return ServiceMgr::getInstance()->RemovePhoto($this->_values['photoid']);
	}
