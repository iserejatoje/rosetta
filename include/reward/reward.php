...
class Reward
{
    ...
    protected $_images_dir = '/common_fs/i/common_rewards/';
    protected $_images_url = '/resources/fs/i/common_rewards/';
    ...
    public function __get($name)
    {
        ...
        if($name == 'worker') {
            return RewardMgr::getInstance()->GetWorkerForReward($this->worker_id);
        }
    ...
    */
    ...
    public function Update()
    {
        if($this->_values['id'] === 0) {
            return  $this->_values['id'] = RewardMgr::getInstance()->AddReward($this->_values);
        } else {
            return RewardMgr::getInstance()->UpdateReward($this->_values);
        }
    }
    ...
    public function Remove()
    {
        ...
        return RewardMgr::getInstance()->RemoveReward($this->_values['id']);
    }
