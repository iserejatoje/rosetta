...
class Opinion
{
    ...
    protected $_images_dir = '/common_fs/i/common_opinions/';
    protected $_images_url = '/resources/fs/i/common_opinions/';
    ...
    */
    ...
    public function Update()
    {
        if($this->_values['id'] === 0) {
            return  $this->_values['id'] = RewardMgr::getInstance()->AddOpinion($this->_values);
        } else {
            return RewardMgr::getInstance()->UpdateOpinion($this->_values);
        }
    }
    ...
    public function Remove()
    {
        ...
        return RewardMgr::getInstance()->RemoveOpinion($this->_values['id']);
    }
