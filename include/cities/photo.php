...
class Photo
{
	...
	private $_images_dir = '/common_fs/i/common_store_photo/';
	private $_images_url = '/resources/fs/i/common_store_photo/';
	...
	*/
	...
	public function Update()
	{
		...
		{
			return  $this->_values["photoid"] = CitiesMgr::getInstance()->AddPhoto($this->_values);
		}
		else
		{
			return CitiesMgr::getInstance()->UpdatePhoto($this->_values);
		}
	}
...
//  Удаление продуктов
	public function Remove()
	{
		...
		return CitiesMgr::getInstance()->RemovePhoto($this->_values['photoid']);
	}
