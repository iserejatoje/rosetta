...
{/literal}
		...
		<table align="center" cellpadding="0" cellspacing="2" border="0" width="100%" class="table2">
			...
			<tr>
				...
				<td nowrap="nowrap">
					<label for="emp">Прямой работодатель</label><br />
			...
			<tr>
				<td width="50%"></td>
				<td valign="top"><input id="emp1" onclick="(this.checked) ? document.getElementById('form_F').style.display = '' : document.getElementById('form_F').style.display = 'none'; "
				 onchange="(this.checked) ? document.getElementById('form_F').style.display = '' : document.getElementById('form_F').style.display = 'none'; " type="radio" name="user_type" value="3" {if $res.user_type == 3 || ($res.user_type == 0 && $smarty.get.status == 3)}checked="checked"{/if}/></td>
				<td nowrap="nowrap">
					<label for="emp1">Кадровое агентство</label><br />
					- для размещения вакансий и резюме
				</td>
				<td valign="top"></td>
				<td nowrap="nowrap"></td>
			...
			<tr>
				<td width="50%"></td>
				<td valign="top"><input id="emp2" onclick="(this.checked) ? document.getElementById('form_F').style.display = '' : document.getElementById('form_F').style.display = 'none'; "
				 onchange="(this.checked) ? document.getElementById('form_F').style.display = '' : document.getElementById('form_F').style.display = 'none'; " type="radio" name="user_type" value="4" {if $res.user_type == 4 || ($res.user_type == 0 && $smarty.get.status == 4)}checked="checked"{/if}/></td>
				<td nowrap="nowrap">
					<label for="emp2">Кадровый центр</label><br />
					- для размещения вакансий и резюме
				</td>
				<td valign="top"></td>
				<td nowrap="nowrap"></td>
