		...
		<td align="center">
			...
			<table cellpadding="0" cellspacing="2" border="0" width="100%" class="table2">
				...
				<tr class="{excycle}" valign="top">
					...
					<td><a href="/{$ENV.section}/{if $l.type=='vacancy'}vacancy{else}resume{/if}/{$l.id}.html?rid={$l.rid}"><b>
						{if $l.hot}<font color="red">{/if}
						{if $l.dolgnost != ''}
							{$l.dolgnost}
						{else}
							{php} $this->_tpl_vars['aid'] =  $this->_tpl_vars['l']['id'] {/php}
