<table border="0" cellspacing="2" cellpadding="0" width="100%" style="padding-left:2px;">
	...
	<tr><td>
		...
		<a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/"|escape:"url"}" target="_blank" class="a16b"><img src="/_img/design/200608_title/common/icon_work_p.gif" border="0"></a></td><td>&nbsp;<a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/"|escape:"url"}" {if $ENV.site.domain == "74.ru"} style="color:red;"{/if} target="_blank" class="a16b">Работа:</a>
		</td></tr>
		</table>
	</td></tr>
{*	<tr><td><a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/"|escape:"url"}" target="_blank" class="a16b"><img src="/_img/design/200608_title/common/icon_work.gif" border="0" width="16" height="16"></a> <a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/"|escape:"url"}" {if $ENV.site.domain == "74.ru"} style="color:red;"{/if} target="_blank" class="a16b">Работа:</a></td></tr>*}
...
{if $ENV.site.domain == "72.ru"}
	<tr><td style="padding-left:10px;"><a href="/service/go/?url={"http://`$ENV.site.domain`/education/"|escape:"url"}" target="_blank">Семинары</a></td></tr>	
{/if}
