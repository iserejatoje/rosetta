...
*}
	...
	<tr>
		<td class="otzyv" style="padding-top:2px">
			<em>{$o.name}</em>: {$o.otziv|truncate:30:"...":true} <a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/comment.html`$l.otz.pageslink.current`"|escape:"url"}" target="_blank">далее</a>
		</td>
	</tr>
	{/foreach}
	{/if}
