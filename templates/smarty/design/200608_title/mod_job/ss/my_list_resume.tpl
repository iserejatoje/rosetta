		...
		<td align="center">
			...
			<table cellpadding="0" cellspacing="2" border="0" width="100%" class="table2">
				...
				<tr class="{excycle}" valign="top">
					...
					<td{if $l.Hide || $l.IsNew == 2} style="color:#999999"{/if}>{$l.MidName} {$l.FirstName} {$l.LastName}<br/>{$l.Name}</td>
					<td><a href="/{$ENV.section}/my/resume/edit/{$l.ResumeID}.php"{if $l.Hide || $l.IsNew == 2} style="color:#999999"{/if}>{$l.Position}</a></td>
