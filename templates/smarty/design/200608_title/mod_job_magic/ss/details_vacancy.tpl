...
{else}
	...
	<table cellpadding="0" cellspacing="2" border="0" width="100%" class="table2" style="table-layout: fixed;">
	{if $res.city}
	<tr>
		<td class="bg_color2" align='right' width="130">Город</td>
		<td class="bg_color4">{$res.city}</td>
...
<br/><br/>
{if in_array($CURRENT_ENV.regid,array(74,2,16,34,59,63,72,61,174,64))}
<!-- Яндекс.Директ -->
