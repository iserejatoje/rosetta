<table border="0" cellspacing="2" cellpadding="0" width="100%" style="padding-left:2px;">  
	...
	<tr><td>
		...
		<a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/"|escape:"url"}" target="_blank" class="a16b"><img src="/_img/design/200608_title/common/icon_work_p.gif" border="0"></a></td><td>&nbsp;<a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/"|escape:"url"}" target="_blank" class="a16b">Работа:</a>
		</td></tr>
		</table>
	</td></tr>
	<tr><td style="padding-left:10px;"><a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/vacancy/1.php"|escape:"url"}" target="_blank" style="color:red;">Вакансии</a> <font class="txt_blue">(<font style="font-size:11px;font-weight:bold;">{$res.vacancy|number_format:0:' ':' '}</font>)</font></td></tr>
...
{if $ENV.site.domain == "74.ru"}
	<tr><td style="padding-left:10px;"><a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/list/vacancy/firm.php"|escape:"url"}" target="_blank">Вакансии компаний</a></td></tr>	
{/if}
