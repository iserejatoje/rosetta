...
<tr valign="top">
	...
	{assign var="td_cnt" value=0}
		...
		<td><a class="t11" href="/{$ENV.section}/vacancy/{$l.rid}/1.php" >{if in_array($l.rid,array(22,23,36,37))}<font color="red">{/if}{$l.rname}{if in_array($l.rid,array(22,23,36,37))}</font>{/if}</a> <span class="t11">(<b>{$l.vcount|number_format:"0":",":" "}</b>)</span></td>
