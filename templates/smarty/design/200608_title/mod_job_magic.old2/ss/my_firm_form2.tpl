		...
		<table align="center" cellpadding="0" cellspacing="2" border="0" width="100%" class="table2">
			<tr>
				<td colspan="6" align="center">
					<br/><br/>
					<b>Для начала работы выберите статус.</b>
					<br/><br/><br/>
				</td>
			</tr>
			<tr>
				<td width="50%"></td>
				<td><input id="emp" onclick="(this.checked) ? document.getElementById('form_F').style.display = '' : document.getElementById('form_F').style.display = 'none'; "
				 onchange="(this.checked) ? document.getElementById('form_F').style.display = '' : document.getElementById('form_F').style.display = 'none'; " type="radio" name="user_type" value="1" {if $res.user_type}checked="checked"{/if}/></td>
				<td><label for="emp">Работодатель</label></td>
				<td><input id="com" onclick="(this.checked) ? document.getElementById('form_F').style.display = 'none' : document.getElementById('form_F').style.display = ''; "
				 onchange="(this.checked) ? document.getElementById('form_F').style.display = 'none' : document.getElementById('form_F').style.display = ''; " type="radio" name="user_type" value="0" {if !$res.user_type}checked="checked"{/if}/></td>
				<td><label for="com">Соискатель</label></td>
				<td width="50%"></td>
			</tr>
		</table>
		{/if}
