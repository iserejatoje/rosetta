		...
		<td align="center">
			...
			<table cellpadding="0" cellspacing="2" border="0" width="100%" class="table2">
				...
				<tr class="{excycle}" valign="top">
					...
					<td align="center" class="text11"{if $l.hide || $l.is_new == 2} style="color:#999999"{/if}><span {if !$l.hide && $l.is_new != 2}style="color:red"{/if}><b>{$l.ptime}</b></span><br/>{$l.pdate}</td>
					<td align="center" class="text11"{if $l.hide || $l.is_new == 2} style="color:#999999"{/if}><span {if !$l.hide && $l.is_new != 2}style="color:red"{/if}><b>{$l.vtime}</b></span><br/>{$l.vdate}</td>
					<td{if $l.hide || $l.is_new == 2} style="color:#999999"{/if}>{$l.fio}<br/>{$l.name}</td>
					<td><a href="/{$ENV.section}/my/resume/edit/{$l.resid}.php"{if $l.hide || $l.is_new == 2} style="color:#999999"{/if}>{$l.dol}</a></td>
