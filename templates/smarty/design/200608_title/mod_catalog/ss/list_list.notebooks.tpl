...
{/if}
{if $l.p23}
<b>Процессор:</b> {$res.property_list.p23.params.prefix}{$l.p23}{$res.property_list.p23.params.postfix}
{/if}
{if $l.p24>0}
{$res.property_list.p24.params.prefix}{$l.p24}{$res.property_list.p24.params.postfix}
{/if}
<br/>
{if $l.p39}
<b>Память:</b> {$res.property_list.p39.params.prefix}{$l.p39}{$res.property_list.p39.params.postfix}
{/if}
{if $l.p40}
{$res.property_list.p40.params.prefix}{$l.p40}{$res.property_list.p40.params.postfix}
{/if}
<br/>
{if $l.p36>0}
<b>HDD:</b> {$res.property_list.p36.params.prefix}{$l.p36}{$res.property_list.p36.params.postfix}
{/if}
{if $l.p38>0}
({$res.property_list.p38.params.prefix}{$l.p38}{$res.property_list.p38.params.postfix})
{/if}
<br/>
{if $l.p52}
<b>CD:</b> {$res.property_list.p52.params.prefix}{$l.p52}{$res.property_list.p52.params.postfix}<br>
{/if}
{if $l.p32}
<b>Дисплей:</b> {$res.property_list.p32.params.prefix}{$l.p32}{$res.property_list.p32.params.postfix}
{/if}
{if $l.p33}
{$res.property_list.p33.params.prefix}{$l.p33|number_format:$res.property_list.p33.params.precision:".":" "}{$res.property_list.p33.params.postfix}
{/if}
{if $l.p34}
({$res.property_list.p34.params.prefix}{$l.p34}{$res.property_list.p34.params.postfix})
{/if}
<br/>
