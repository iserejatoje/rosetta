...
{/if}
{if $l.p10>0}
<b>Матрица:</b> {$res.property_list.p10.params.prefix}{$l.p10|number_format:$res.property_list.p10.params.precision:".":" "}{$res.property_list.p10.params.postfix}<br/>
{/if}
{if $l.p11>0}
<b>Разрешение:</b> {$res.property_list.p11.params.prefix}{$l.p11}{$res.property_list.p11.params.postfix}<br/>
{/if}
{if $l.p19>0}
<b>Оптический зум:</b> {$res.property_list.p19.params.prefix}{$l.p19|number_format:$res.property_list.p19.params.precision:".":" "}{$res.property_list.p19.params.postfix}<br/>
{/if}
{if $l.p20>0}
<b>Цифровой зум:</b> {$res.property_list.p20.params.prefix}{$l.p20|number_format:$res.property_list.p20.params.precision:".":" "}{$res.property_list.p20.params.postfix}<br/>
{/if}
{if $l.p35>0}
<b>Дисплей:</b> {$res.property_list.p35.params.prefix}{$l.p35|number_format:$res.property_list.p35.params.precision:".":" "}{$res.property_list.p35.params.postfix}<br/>
{/if}
