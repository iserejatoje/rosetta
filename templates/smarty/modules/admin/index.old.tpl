...
function ShowPopupMenu(obj, type, id)
{
	...
	if({$l.id}==type)
		text+="{$l.text}";
	{/foreach}
	{literal}text+= Separator()+"<tr><td onmouseover=\"SelectElement(this)\" class=\"esimple\"><a href=\"main.php?section_id="+id+"&maction=property\" target=\"mainView\">Свойства</a></td></tr>";
	text+= "</table>";
...
<table width="100%" height="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td width="180" valign="top"><table width="100%" height="100%" cellspacing="0" cellpadding="0"><tr><td height="100%">
			<div style="width:180px;height:100%;overflow-y:auto;overflow-x:scroll">{$menu}</div></td></tr><tr><td>
			<div style="width:180px;padding:3px;background-color:#f3f3f3;" align="center"><a href="heap.php" target="mainView">Объявления</a><br><a href="forum.php" target="mainView">Форумы</a></div></td></tr></table>
		</td>
		<td width="1" valign="top" bgcolor="#eeeeee" style="overflow:hidden">&nbsp;</td>
		<td height="100%"><iframe src="main.php{if $SECTION_ID!=null}?section_id={$SECTION_ID}{/if}" width="100%" height="100%" frameborder="no" name="mainView" id="mainView"></iframe></td>
	</tr>
</table>
