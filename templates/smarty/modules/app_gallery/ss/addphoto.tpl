...
{*<div class="title" style="padding: 5px">Добавить фотографию</div>*}
...
<table cellspacing="2" cellpadding="3" border="0" align="center" width="550">
	...
	<tr>
		<td colspan="2" align="center"><br/><input type="submit" value="{if $page.action == 'editphoto'}Сохранить{else}Создать{/if}">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Отмена" onclick="document.location.href='/{$ENV.section}/gallery/{$page.gallery}/'" style="width:100px"></td>
	</tr>
	<tr>
