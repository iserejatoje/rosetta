...
<!--regid={$CURRENT_ENV.regid}-->
	<tr>
		<td>
			<table class="t12" cellpadding="5" cellspacing="0" border="0">
				{if !empty($l.group)}{assign var="_group" value="`$l.group`"}{else}{assign var="_group" value=""}{/if}
				<tr><td align="left" class="t9b">{*<a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/`$_group`"|escape:"url"}" target="_blank" class="t9b">*}
	...
	<tr>
		<td class="block_content">
			...
			{foreach from=$l.otz.list item=o}
				<div class="otzyv" style="padding-top:15px;">
