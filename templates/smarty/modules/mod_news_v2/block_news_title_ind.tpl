	...
	<tr>
		<td>
			<table class="txt1" cellpadding="0" cellspacing="0" border="0">
				...
				<tr><td class="txt1" align="left" style="padding:1px;padding-left:10px;padding-right:10px;"><a href="/service/go/?url={"http://`$ENV.site.domain`/`$ENV.section`/`$_group`"|escape:"url"}" target="_blank" class="txt1">
...
*}
	<tr>
		<td class="block_content">
			...
			<a href="/service/go/?url={"`$l.url`"|escape:"url"}" target="_blank" class="txt2">
			{if $l.type==2}
	...
	<tr>
		<td class="txt4" style="padding-top:2px">
			<font class="txt3">{$o.name}</font>: {$o.otziv|truncate:30:"...":true} <a href="/service/go/?url={"`$o.url`"|escape:"url"}" target="_blank" class="txt5">далее</a>
		</td>
	</tr>
	{/foreach}
	{/if}
