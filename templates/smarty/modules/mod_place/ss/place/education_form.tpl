...
{if $res.placeinfo.type == constant('PlaceMgr::PT_HIGHER_EDUCATION')}
<div align="center" style="margin-top:20px">
	<table align="center" border="0" cellpadding="3" cellspacing="2" width="550">
		...
		<tr>
			...
			<td class="bg_color4">
				<input type="text" name="place[{$res.placeinfo.type}][faculty][]" value="{$res.placeinfo.faculty|escape}" style="width:100%;"  maxlength="255" />
			</td>
		</tr>
	...
	{elseif $res.placeinfo.type == constant('PlaceMgr::PT_SECONDARY_EDUCATION')}
<div align="center" style="margin-top:20px">
	<table align="center" border="0" cellpadding="3" cellspacing="2" width="550">
		<tr>
			<td class="bg_color2" colspan="3" align="right"><a href="javascript:void(0)" onclick="$(this.parentNode.parentNode.parentNode.parentNode.parentNode).remove();" class="text11">Удалить</a></td>
