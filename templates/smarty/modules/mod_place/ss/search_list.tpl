...
{if empty($res.place_list) }

	<br/><br/><div align="center" class="error"><span><b>По Вашему запросу ничего не найден.</b></span>
	<br/><br/>
	...
	<tr class="{excycle}" valign="top">		
		<td align="center">
			{if $l.LogotypeSmall.file}
				<a href="/service/place/{$l.PlaceID}"><img src="{$l.LogotypeSmall.file}" width="{$l.LogotypeSmall.w}" height="{$l.LogotypeSmall.h}" border="0"/></a><br/>
				<img src="/_img/x.gif" width="1" height="5"><br/>
			{/if}
			<a href="/service/place/{$l.PlaceID}">{$l.Name}</a>
		</td>
