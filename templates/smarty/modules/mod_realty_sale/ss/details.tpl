...
{if $page.adv.city.name}
		<tr align="left">
			<td align="right" class="bg_color2">Город:</td>
			<td colspan="2" class="bg_color4">{$page.adv.city.name}</td>
		</tr>
{/if}
{if $page.adv.region.name}
		<tr>
			<td align="right" width="150" class="bg_color2">Район:</td>
			<td colspan="2" class="bg_color4">{$page.adv.region.name}</td>
		</tr>
{/if}
		<tr>
...
{if $page.adv.age_build>0}
		<tr>
			<td align="right" width="150" class="bg_color2">Возраст здания:</td>
			<td colspan="2" class="bg_color4">{$ENV._arrays.age_build[$page.adv.age_build].b}</td>
		</tr>
{/if}
...
{if $page.adv.contacts}
		<tr>
			...
			<td colspan="2" class="bg_color4">{$page.adv.contacts|strip_tags}
                        {if !empty($page.adv.replyjs)}
			<br><a href="#" onclick="{$page.adv.replyjs};return false;">Отправить личное сообщение.</a>
...
{if count($page.adv.img)>0}
		<tr bgcolor="#ffffff" align="left">
			<td align="center" colspan="3" class="ssyl">
				<div align="center" class="ssyl">
					<a name="photo"></a><b>Фотографии</b>
				</div>
			</td>
		</tr>
