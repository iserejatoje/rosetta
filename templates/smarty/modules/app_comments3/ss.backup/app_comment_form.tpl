{if $CURRENT_ENV.site.domain == 'domchel.ru'}
	<div align="center" style="padding: 5px 0px">{banner_v2 id="1739"}</div>
{/if}
<div class="js-comment">
<div><a href="javascript:;" onclick="commentForm.moveForm(0);" class="title">Добавить комментарий</a></div>
...
<div class="js-comments-form-holder-0">
	<div class="js-comments-form-holder">
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="js-comments-field-holder">
			<tr>
				<td>
					<form method="post" style="margin:0px" class="js-comments-field-data">
					...
					<table width="100%" border="0" cellspacing="5" cellpadding="0">
						...
						<tr>
							<td colspan="4" align="left">
								<input class="js-comments-field-submit" type="button" onclick="commentForm.checkForm();" value="Отправить">&nbsp;&nbsp;
