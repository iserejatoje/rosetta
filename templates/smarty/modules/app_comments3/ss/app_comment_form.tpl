{*{if $CURRENT_ENV.site.domain == 'domchel.ru' && in_array($CURRENT_ENV.section, array('comp', 'renovation'))}
	<div align="center" style="padding: 5px 0px">{banner_v2 id="2584"}</div>
{else}
	<div align="center" style="padding: 5px 0px">{banner_v2 id="3330"}</div>
{/if}*}
<div class="js-comment">
<div class="add-comment"><a name="add-comment"></a>
...
{if $CURRENT_ENV.site.domain == 'domchel.ru'}
	{if in_array($CURRENT_ENV.section, array('renovation'))}
		<div style="padding: 0px 5px;"><font style="color: red;">Сайт DomChel.ru - за конструктивную критику!<br />
		Просим проявлять уважение к участникам конкурса &laquo;Сезон ремонта&raquo; при комментировании работ.<br />
		В противном случае комментарии выставляться не будут.</font><br /><br /></div>
		<div align="center" style="padding: 5px 0px">{banner_v2 id="2354"}</div>
	{else}
		<br /><div style="padding: 10px;"><noindex>{banner_v2 id="2271"}</noindex></div>
	{/if}
{/if}
{if in_array($CURRENT_ENV.site.domain, array("autochel.ru","102km.ru","116auto.ru","34auto.ru","avto59.ru","161auto.ru","doroga63.ru","72avto.ru"))}
	<br /><div style="padding: 10px;"><noindex>{banner_v2 id="4004"}</noindex></div>
{/if}
{if in_array($CURRENT_ENV.site.domain, array("chelfin.ru","102banka.ru","116dengi.ru","34banka.ru","dengi59.ru","161bank.ru","dengi63.ru","72dengi.ru"))}
	<br /><div style="padding: 10px;"><noindex>{banner_v2 id="3546"}</noindex></div>
{/if}
{if in_array($CURRENT_ENV.site.domain, array('cheldoctor.ru', '102doctora.ru'))}
	<br /><div style="padding: 10px;"><noindex>{banner_v2 id="3572"}</noindex></div>
{/if}