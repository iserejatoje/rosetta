...
{if $l.p58>0}
<b>Цена:</b> {$res.property_list.p58.params.prefix}{$l.p58|number_format:$res.property_list.p58.params.precision:".":" "}{$res.property_list.p58.params.postfix}<br/>
{/if}
{if $l.p24>0 && array_key_exists($l.p24, $res.common.arrays.p24)}
<b>Тип:</b> {$res.common.arrays.p24[$l.p24].name}{if $l.p33>0 && array_key_exists($l.p33, $res.common.arrays.p33)} ({$res.common.arrays.p33[$l.p33].name}){/if}<br/>
{/if}
{if $l.p15>0}
<b>Диагональ:</b> {$res.property_list.p15.params.prefix}{$l.p15|number_format:$res.property_list.p15.params.precision:".":" "}{$res.property_list.p15.params.postfix}<br/>
{/if}
{if $l.p16>0 && array_key_exists($l.p16, $res.common.arrays.p16)}
<b>Формат:</b> {$res.property_list.p16.params.prefix}{$res.common.arrays.p16[$l.p16].name}{$res.property_list.p16.params.postfix}<br/>
{/if}
{if $l.p17>0 && array_key_exists($l.p17, $res.common.arrays.p17)}
<b>Разрешение:</b> {$res.property_list.p17.params.prefix}{$res.common.arrays.p17[$l.p17].name}{$res.property_list.p17.params.postfix}<br/>
{/if}
{if $l.p18>0}
<b>Яркость:</b> {$res.property_list.p18.params.prefix}{$l.p18|number_format:0:".":" "}{$res.property_list.p18.params.postfix}<br/>
{/if}
{if $l.p19>0}
<b>Контрастность:</b> {$res.property_list.p19.params.prefix}{$l.p19|number_format:0:".":" "}{$res.property_list.p19.params.postfix}<br/>
{/if}
