...
{if $page.title}
{* Top title *}
	<tr class="s_lines" style="padding-left: 15px;">
		<td colspan="2" class="t14b">
...
{/if}
	...
	{if $page.advs_count.commerce[$ENV._params.rubric][$ENV._params.status][0] !=""}
		...
		&nbsp;<font class="ssy4">{$page.advs_count.commerce[$ENV._params.rubric][$ENV._params.status][0]} 
...
{if $USER->IsAuth()}&nbsp;|&nbsp;
<a href="/{$ENV.cp_section}/" class="data">Личный кабинет</a>
{/if}
&nbsp;|&nbsp;
...
{foreach from=$ENV._arrays.rubrics item=_v key=_k}
	...
	<tr>
		<td align="right" class="t11_grey">&nbsp;{$_v} {$page.advs_count.commerce[$_k][0][0]}
