...
<center>
Для добавления вакансии или резюме вам необходимо <a href="/{$CURRENT_ENV.section}/?cmd=regfrm">зарегистрироваться</a>.<br/>Если вы уже 
зарегистрированы, то воспользуйтесь формой входа.
</center>
<br/><br/>
		...
		<td>
			<table cellpadding="4" cellspacing="1" border="0" width="100%" >
				...
				<tr>
					...
					<!-- конец формы забыли пароль -->Имя и пароль будут высланы вам по электронной почте.
					</td>
				</tr>
			</table>
		</td>
