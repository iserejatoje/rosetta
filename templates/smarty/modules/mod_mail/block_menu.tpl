...
{if $res.is_auth}
	...
	<td onmouseover="menu_top2_over(this);" onmouseout="menu_top2_out(this);" class="menu_top2"><span><a href="/{$ENV.section}/help.common.html">Помощь</a></span></td>
...
{else}
	<td onmouseover="menu_top2_over(this);" onmouseout="menu_top2_out(this);" {if $res.page=='default'}bgcolor="#ffffff" class="menu_top2_selected"{else}class="menu_top2">{/if}<span><a href="/{$ENV.section}/">Вход</a></span></td>
