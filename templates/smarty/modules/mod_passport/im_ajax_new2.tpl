<form style="margin:0px" method="POST" enctype="multipart/form-data" id="im_form" action="/passport/im/ajax_new.php">
							...
							<tr>
								<td>
									<div style="position:absolute;display:none;" id="im_form_smiles">
										<div style="position:relative;width:400px;height:180px;background-color:white;overflow-y:auto;padding-top:10px;border-left:2px solid #F0F0F0;border-top:2px solid #F0F0F0;border-bottom:2px solid #D0D0D0;border-right:2px solid #D0D0D0">
					...
					<td>
						<table width="100%" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="1">&nbsp;</td>
								<td class="tip" valign="top">вы можете прикрепить файл к сообщению, тут хелп</td>
							</tr>
						</table>
					</td>
				</tr>
