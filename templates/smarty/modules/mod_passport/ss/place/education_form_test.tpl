...
onclick="{if $res.placeinfo.placeid && $res.with_suggest}mod_passport.removePlace({$res.placeinfo.placeid}, {$res.placeinfo.type});{/if}$(this.parentNode.parentNode.parentNode.parentNode.parentNode).remove();" class="text11">Удалить</a></td>
		...
		<tr>
			...
			<td class="bg_color4">
				<input id="faculty{$res.placeinfo.fix}" type="hidden" name="faculty[{$res.placeinfo.type}][id][]" value="{$res.placeinfo.placeid}" />
				<input type="text" id="faculty_suggest{$res.placeinfo.fix}" name="place[{$res.placeinfo.type}][faculty][]" value="{$res.placeinfo.faculty|escape}" style="width:100%;"  maxlength="255" />
				{if $res.with_suggest === true}<script>
				<!--
				{literal}
				$(document).ready(function() {
		...
		<tr>
			...
			<td class="bg_color4">
				<input id="chair{$res.placeinfo.fix}" type="hidden" name="chair[{$res.placeinfo.type}][id][]" value="{$res.placeinfo.placeid}" />
				<input type="text" name="place[{$res.placeinfo.type}][chair][]" id="chair_suggest{$res.placeinfo.fix}" value="{$res.placeinfo.chair|escape}" style="width:100%;"  maxlength="255" />
				{if $res.with_suggest === true}<script>
				<!--
				{literal}
				$(document).ready(function() {
...
onclick="{if $res.placeinfo.placeid && $res.with_suggest}mod_passport.removePlace({$res.placeinfo.placeid}, {$res.placeinfo.type});{/if}$(this.parentNode.parentNode.parentNode.parentNode.parentNode).remove();" class="text11">Удалить</a></td>
		...
		<tr>
			...
			<td class="bg_color4">
				<input id="place{$res.placeinfo.fix}" type="hidden" name="place[{$res.placeinfo.type}][id][]" value="{$res.placeinfo.placeid}" />
				<input id="suggest{$res.placeinfo.fix}" type="text" name="place[{$res.placeinfo.type}][name][]" value="{$res.placeinfo.name|escape}" style="width:100%;" />
		...
		<tr>
			...
			<td class="bg_color4">
				<input type="text" name="place[{$res.placeinfo.type}][chair][]" value="{$res.placeinfo.chair|escape}" style="width:100%;" maxlength="255" />
			</td>
		</tr>
