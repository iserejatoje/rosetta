...
{* эта роль поидее есть только у админов... вообще можно снести этот блок *}
{*
{if $page.role_info_view}
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:10px;">
<tr>
	<td class="block_title4"><span>Контакты</span></td>
	<td class="block_title4" align="right">&nbsp;</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:10px;">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:10px;">
<tr>
	<td class="block_title4"><span>Место работы</span></td>
	<td class="block_title4" align="right">&nbsp;</td>
