...
{php}
	...
	$this->_tpl_vars['res'] = array(
		...
		'city_arr'		=> (( isset($this->_tpl_vars['page']['form']['city_arr'][$this->_tpl_vars['l']['countrycode']]) ) ? $this->_tpl_vars['page']['form']['city_arr'][$this->_tpl_vars['l']['countrycode']] : $this->_tpl_vars['page']['form']['city_arr']),
...
<tr><td align="right">
		...
		<a id="append_education_{php}echo PlaceSimpleMgr::PT_OTHER;{/php}" href="javascript:void(0)" 
			onclick="mod_passport.getPlaceForm({php}echo PlaceSimpleMgr::PT_OTHER;{/php}, this)" class="text11">Добавить еще одно место</a>
