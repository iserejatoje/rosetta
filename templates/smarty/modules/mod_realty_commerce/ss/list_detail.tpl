...
{foreach from=$page.list item=l key=_k}
			...
			<table width="100%" cellspacing="1" border="0" class="table2">
				...
				<tr>
					<td{if $l.imp>0} style="color:red"{/if} align="right" width="150" class="bg_color2">Тип здания:</td>
					<td{if $l.imp>0} style="color:red"{/if} class="bg_color4"><b>{$ENV._arrays.types[$l.object][$l.type]}</b></td>
				</tr>
				{/if}
				{if $l.object != 2}
			...
			{$ENV._arrays.site_unit[$l.area_site_unit]}</td>
				...
				<tr>
					...
					<td{if $l.imp>0} style="color:red"{/if} class="bg_color4">{$l.contacts|strip_tags|trim}
