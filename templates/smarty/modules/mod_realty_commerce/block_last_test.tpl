		...
		{if is_array($BLOCK.res.list) && sizeof($BLOCK.res.list)}
			<table width="100%" cellspacing="1" border="0" class="table2">
				<tr valign=middle>
					...
					<th width="70">Площадь<br />помещения<br />(кв.м.)</th>
					<th width="70">Площадь<br />участка</th>
				</tr>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		{if $BLOCK.res.user_id == $USER->ID}
		<td nowrap="nowrap"><img height="7" border="0" width="7" alt="" src="/img/bullspis.gif"/>&nbsp;</td>
