...
<tr>
	<td width="20">&nbsp;</td>
	<td bgcolor="#87b30a" width="3">  
		<img height="1" width="3" src="/_img/x.gif"/>
	</td>
	<td>
	...
	{foreach from=$res.list.categories item=category}
		...
		<tr>
			...
			<table width="100%"  border="0" cellspacing="1" cellpadding="1">
				<tr valign="top">
					<td width="96">{if !empty($event.photo)}<a href="/{$CURRENT_ENV.section}/event/{$event.id}.php"><img src="{$event.photo.url}" width="{$event.photo.w}" height="{$event.photo.h}" border="0"></a>{/if}</td>
