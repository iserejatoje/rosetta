<div style="position:relative;text-align:left;width:300px;padding-left:10px;padding-right:10px;">
	<div style="float:left;padding-right:10px;">
		...
		{if $config.is_configurable}
			<div class="widgetButtonConfigure widgetButtonTitle txt_color5" style="font-size:10px;cursor:pointer;" title="настройка">
				<div style="margin-top: -2px;text-align:center;">
					<a href="javascript:void(0);" style="border-bottom:dashed 1px;text-decoration:none; position:relative;">настройки</a>
				</div>
			</div>
		{/if}
	</div>
