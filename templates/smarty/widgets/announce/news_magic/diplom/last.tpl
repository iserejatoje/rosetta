<table width="100%" cellspacing="0" cellpadding="0" border="0">
      <tbody><tr>
        <td width="40"><img width="40" height="41" src="/_img/design/200710_diplom/icoleft2.gif"/></td>
        <td valign="top" background="/_img/design/200710_diplom/backleftzag.gif" align="right"><font class="zag0">{$res.title}</font>  </td>
      </tr>
  </tbody></table>
...
{* это случай с текстом, здесь все форматировано по левому краю *}
	{foreach from=$res.list item=l}
		...
		{else}
			{$l.Title}
		{/if}
		</a>{if $l.AddMaterial==1} <img src="/_img/design/200710_diplom/photo_blue.gif" title="Содержит фотоматериалы" alt="Содержит фотоматериал" width="14" height="10" />{elseif $l.AddMaterial==2} <img src="/_img/design/200608_title/common/video_blue.gif" title="Содержит видеоматериалы" alt="Содержит видеоматериалы" width="14" height="12" />{/if}
		</td><tr>
		<tr><td align="left" style="padding-bottom:2px">
