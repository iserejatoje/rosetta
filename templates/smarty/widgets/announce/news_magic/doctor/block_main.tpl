<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td width="10"><img src="/_img/design/200710_doctor/bokzag1.gif" width="10" height="24" alt="" /></td>
		<td bgcolor="#E3F6FF" class="block_main">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr><th><span>{$res.title}</span></th></tr>
			</table>
		</td>
		<td width="11"><img src="/_img/design/200710_doctor/bokzag2.gif" width="11" height="24" alt="" /></td>
	</tr>
	<tr>
...
{/if}
	<div>
		...
		<span class="bl_title"><a href="{$l.Link}{$l.Date|date_format:"%Y"}/{$l.Date|date_format:"%m"}/{$l.Date|date_format:"%d"}/#{$l.NewsID}" {if $l.Order>0}style="color:red;"{/if}>{$l.Title}</a></span>
