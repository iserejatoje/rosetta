...
{if !empty($l.Comment)}
				...
				<span class="comment_time"> {$l.Comment.Created|date_format:"%H:%M"}:</span> 
...
{* это случай без текстом, здесь все форматировано по центру *}
	{foreach from=$res.list item=l key=k}
		<tr><td style="border:0px;"><div align="center" style="padding:0px"><span class="bl_date_news">{$l.Date|date_format:"%e"} {$l.Date|month_to_string:2}</span></div></td></tr>
