...
<table width="100%" cellpadding="0" cellspacing="4" border="0">
	...
	<tr>
		<td class="t12">
			...
			<table class="t12" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="t13_grey2" align="left" style="padding:1px;padding-left:10px;padding-right:10px;{if $res.Title=="Новости от пользователей сайта"}color:red;{/if}">{$res.Title}</td>
				...
				<tr>
					<td align="left" height="1" bgcolor="{if $res.Title=="Новости от пользователей сайта"}red{else}#666666{/if}"><img src="/_img/x.gif" width="1" height="1" border="0" alt="" /></td>
					<td></td>
				</tr>
			</table>
			{/if}
	...
	{foreach from=$res.newsList item=l key=k}
		...
		<tr>
			<td class="t12" {*{if $l->AddMaterial == 2 || $l->AddMaterial == 3}style="background-color: #d7e8ea;"{/if}*}>
			{*<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
			{if $l->AddMaterial==2 || $l->AddMaterial == 3}<td style="background-color: #a8d5db; width: 19px;" valign="top"><img src="/_img/design/200608_title/common/video_green.gif" title="Содержит видеоматериалы" alt="Содержит видеоматериалы" hspace="3" vspace="3"></td>
			...
			{if $l->AddMaterial == 1}
				<img src="/_img/design/200608_title/common/photo_blue.gif" title="Содержит фотоматериалы" alt="Содержит фотоматериал">
			{elseif $l->AddMaterial == 2 || $l->AddMaterial == 3}
				<img src="/_img/design/200608_title/common/video_blue.gif" title="Содержит видеоматериалы" alt="Содержит видеоматериалы">
			{/if}
                        {*</td>
			</tr></table>*}
