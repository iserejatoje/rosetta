...
<form role="form" class="form-horizontal" name="new_object_form" method="post" enctype="multipart/form-data">
	...
	<table class="form table table-sriped">
		...
		<tr>
			<td class="header-column">Цвет фона</td>
			<td class="data-column">
				<? if (($err = UserError::GetErrorByIndex('Title')) != '' ) { ?>
				<span class="error"><?=$err?></span><br/>
				<? } ?>
				<div class="input-group colorpicker">
					...
					<input class="form-control" id="share-bg-color" name="BGColor" value="<?=UString::ChangeQuotes($vars['form']['BGColor'])?>">
				</div>
			</td>
		</tr>

		<tr>
			<td class="header-column">Текст акции</td>
			<td class="data-column">
		...
		<tr>
			<td class="header-column">Изображение<br/><small>(352х393px) Изображение в PNG формате следует сразу загружать в указанном размере.</small></td>
			<td class="data-column">
