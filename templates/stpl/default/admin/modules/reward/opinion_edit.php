    ...
    <table class="form table table-sriped">
        <tr>
            ...
            <td class="data-column">
                <input type="checkbox" name="is_visible" value="1"<?php if ($vars['form']['is_visible'] == 1) { ?> checked="checked"<? } ?>>
            </td>
        </tr>

    	<tr>
            <td class="header-column">Фото<br/><small><b>184x184px</b><br>(без ресайза)</small></td>
            <td class="data-column">
        ...
        <?php /*
        <tr>
            <td class="header-column">Фото<br/><small><b></b></small></td>
            <td class="data-column">
        ...
        */?>
        ...
        <tr>
            <td class="header-column">Должность кто оставляет отзыв</td>
            <td class="data-column">
        ...
        <tr>
            <td class="header-column">Текст отзыва</td>
            <td class="data-column">
