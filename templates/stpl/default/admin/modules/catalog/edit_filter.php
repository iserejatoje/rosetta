...
<script>
	function addFilter()
	{
		$('.items').append('<tr><td></td><td><input class="form-control" type="text" name="param_name[]" value=""></td><td><input class="form-control" type="text" name="param_value[]" value=""></td><td><a class="btn btn-danger btn-sm" onclick="remove_param(this)" href="javascript:;" title="Удалить параметр"><span class="glyphicon glyphicon-trash"></span></a></td></tr>');
	}
