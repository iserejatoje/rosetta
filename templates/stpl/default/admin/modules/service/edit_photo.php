...
<form name="new_object_form" method="post" enctype="multipart/form-data">
    ...
    <table class="form table table-sriped">
        ...
        <tr>
            <td class="header-column">Маленькое фото для списка<br/><small><b>132px × 132px</b></small></td>
            <td class="data-column">
        ...
        <tr>
            <td class="header-column">Большое фото для списка<br/><small><b>393px × 392px</b></small></td>
            <td class="data-column">
        ...
        <tr>
            <td class="header-column">Большое фото<br/><small><b>785px × 660px</b></small></td>
            <td class="data-column">
