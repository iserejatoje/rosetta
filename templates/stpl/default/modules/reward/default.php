...
<div class="container">
    ...
    <div class="page-mastery">
        ...
        <?php if ($vars['rewards'] === false) { ?>
            <div style="margin: 150px 0px; text-align: center; font-size: 24px;">
                Раздел наполняется
            </div>
        <?php } else { ?>
        ...
        <?php if($opinions) { ?>
            ...
            <div class="show-all-button">
                <?php if($vars['hasMore']) { ?>
                    <button type="button" class="btn-violet load-more-handl">Показать все отзывы маэстро</button>
                <?php } ?>
            </div>
        <?php } ?>
    </div>
...
<div class="gallery-media">
    <div class="gallery-media__close">
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.52403 7L0 1.47597L1.47597 0L7 5.52403L12.524 0L14 1.47597L8.47597 7L14 12.524L12.524 14L7 8.47597L1.47597 14L0 12.524L5.52403 7Z" fill="white"/>
        </svg>
    </div>
