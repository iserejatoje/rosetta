        ...
        <tr>
          <td>
            ...
            <table class="twelve columns" style="background: #fff;" cellspacing="0" cellpadding="0" >
                <tr style="height: 6px;">
                    <td style="background: url(<?= App::$Protocol . $vars['domain'] ?>/resources/img/design/rosetta/mail/fence.png) repeat-x; padding: 0;"></td>
                </tr>
              ...
              <tr>
                <td style="padding-bottom: 0;">
                  <img src="<?= App::$Protocol . $vars['domain'] ?>/resources/img/design/rosetta/mail/discount.jpg">
                </td>
              </tr>

              <tr>
                <td style="padding: 0 270px 0 150px;">
                  <table cellspacing="0" cellpadding="0" >
                    ...
                    <tr>
                      <td class="body-paragraph" colspan="2">
                    ...
                    <tr>
                      <td class="body-paragraph" colspan="2">
                        Предоставляем Вам дисконтную карту со скидкой 5%, номер которой
                        Вы сможете использовать на все следующие покупки в нашем
                        интернет-магазине "РОЗЕТТА".
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td class="body-paragraph" colspan="2">
                        С правилами использования дисконтной карты Вы можете ознакомиться <a href="#" class="link-pink">здесь.</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <table cellspacing="0" cellpadding="0" >
                                <tr>
                                    <td height="56px" width="150px" bgcolor="#e73a62" align="center">
                                        <font color="#ffffff" size="3"><strong><?=$vars['cardcode']?></strong></font>
                                    </td>
                                    <td width="350px">
                                        &nbsp;&nbsp;&nbsp;<font color="#888888">номер вашей дисконтной карты</font>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <table class="twelve columns" cellspacing="0" cellpadding="0" width="100%">
                ...
                <td class="follow-links">
                  <center>
                    <a href="https://vk.com/rosetta_florist" target="_blank" class="btn-social">
                      <img src="<?= App::$Protocol . $vars['domain'] ?>/resources/img/design/rosetta/mail/btn-vk.png">
                    </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="https://www.instagram.com/rosetta_kemerovo/" target="_blank" class="btn-social">
                      <img src="<?= App::$Protocol . $vars['domain'] ?>/resources/img/design/rosetta/mail/btn-inst.png">
                    </a>
                  </center>
                </td>
              </tr>
              ...
              <tr>
                <td class="follow-footnote" style="padding: 10px 0 25px 0; text-align: center;">
                    <font color="#898989">Если у Вас возникли трудности, обратитесь <a href="<?= App::$Protocol . $vars['domain'] ?>" target="_blank">к нам</a></font>
                </td>
              </tr>
            </table>
