...
return array(
	'files' => array(
		...
		'get' => array(
			'messages'	=> array('regexp' => '@^(popup/)?msg\.([a-z0-9\-_]+)\.html@', 'matches' => array(1 => 'popup', 2 => 'message')),
			...
			'popup_gallery' => array('regexp' => '@^(popup)/gallery/([\d]+)\.php@', 'matches' => array(1 => 'popup', 2 => 'gallery'), 'file' => 'app_gallery2/get_gallery.php'),
			'popup_album' 	=> array('regexp' => '@^(popup)/album/([\d]+)\.php@', 'matches' => array(1 => 'popup', 2 => 'album'), 'file' => 'app_gallery2/get_album.php'),
			'popup_addphoto'=> array('regexp' => '@^(popup)/album/([\d]+)/addphoto.php@', 'matches' => array(1 => 'popup', 2 => 'album'), 'file' => 'app_gallery2/get_addphoto.php'),
	...
	'templates'	=> array(
		...
		'pages_link'		=> '_modules/app_gallery/pages_link.tpl',
		'ssections'	=> array(
			'popup_gallery'	=> '_modules/app_gallery/ss/popup_gallery.tpl',
			'popup_album'	=> '_modules/app_gallery/ss/popup_album.tpl',
			'popup_addphoto'=> '_modules/app_gallery/ss/popup_addphoto.tpl',
