...
class Widget_announce_general extends IWidget
{
    ...
    public function OnMainSlider()
    {
        ...
        list($products, $product_counts) = CatalogMgr::GetInstance()->GetProducts($filter);
        ...
        foreach ($products as $product) {
            ...
            if($category->kind == CatalogMgr::CK_BOUQUET)
            {
                ...
                $prices[$product->id] = $product->GetPrice();;
    ...
    protected function OnCatalog()
    {
        ...
        $composition = CatalogMgr::GetInstance()->GetMembers($filter);
        $template = 'default';
        ...
        $filter_type = CatalogMgr::GetInstance()->GetFilterByName('type');
        if($filter_type !== null) {
        ...
        $filter_whom = CatalogMgr::GetInstance()->GetFilterByName('whom');
        if($filter_whom !== null) {
        ...
        $filter_flower = CatalogMgr::GetInstance()->GetFilterByName('flowers');
        ...
        $filter_cause = CatalogMgr::GetInstance()->GetFilterByName('cause');
