<?
class Widget_announce_article extends IWidget
{
	protected $_db;
	private	$captcha;
	private	$_cache;
	...
	public function Init($path, $state = null, $params = array())
	{
		...
		LibFactory::GetMStatic('article', 'articlemgr');
				
		$this->_db = DBFactory::GetInstance($this->config['db']);
		$this->_cache = new Cache();
		$this->_cache->Init('memcache', 'article_widget');
	}
	
	protected function OnLastArticle()
	{	
