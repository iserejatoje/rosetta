...
class Smarty_Compiler extends Smarty {
    ...
    {	
		...
		// farid: дописываем в параметры имя текущего файла и строку, чтобы передать его в обработчик ошибки
        $_params = "array('smarty_include_tpl_file' => " . $include_file . ", 'smarty_include_vars' => array(".implode(',', (array)$arg_list)."), 'smarty_current_file' => '".$this->_current_file."', 'smarty_current_line_no' => ".$this->_current_line_no.")";
